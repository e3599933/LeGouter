...
CREATE TABLE `emp_function` (
  ...
  `FUNCTION_CONTENT` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`FUNCTION_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emp_function`
--

LOCK TABLES `emp_function` WRITE;
/*!40000 ALTER TABLE `emp_function` DISABLE KEYS */;
/*!40000 ALTER TABLE `emp_function` ENABLE KEYS */;
UNLOCK TABLES;
