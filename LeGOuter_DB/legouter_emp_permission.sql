...
CREATE TABLE `emp_permission` (
  ...
  CONSTRAINT `emp_permission_ibfk_1` FOREIGN KEY (`EMP_ID`) REFERENCES `emp` (`EMP_ID`),
  CONSTRAINT `emp_permission_ibfk_2` FOREIGN KEY (`FUNCTION_ID`) REFERENCES `emp_function` (`FUNCTION_ID`)
